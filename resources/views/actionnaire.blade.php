...
@section('content')
    <div class="row page-titles" style="margin-top: 20px; margin-left: 20px;">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Liste des emprunts en cours</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 20px; margin-left: 20px; margin-right: 20px">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title"><div class="btn btn-danger"><i class="fa fa-book"></i><a href="" style="color: white">   Tous les emprunts</a> </div></div>
